...
description: "Frame a new engineering effort with goals, constraints, success metrics, and explicit unknowns before implementation begins."
doc_status: draft
tags:
  - playbook
---
...
Frame a new engineering effort with goals, constraints, success metrics, and explicit unknowns before implementation begins.

## When to use

- A new initiative is forming and scope is still fuzzy.
- Stakeholders need alignment on problem statement and definition of done.

## Inputs required

- Problem statement draft or ticket
- Business constraints (timeline, budget, compliance)
- Known technical constraints or legacy dependencies
- Link to product brief or client SOW if applicable
...
```text
You are assisting Innerflect on: Project intake.
...
Task:
Execute "Project intake" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: development
Playbook file: project-intake.md
```
