---
title: "Client intake"
description: "Capture client context, stakeholders, goals, constraints, and success measures in a durable intake artifact."
doc_status: draft
tags:
  - playbook
---
...
Capture client context, stakeholders, goals, constraints, and success measures in a durable intake artifact.

## When to use

- New engagement or phase starting.
- Handoff from sales to delivery needs clean inputs.

## Inputs required

- Commercial outline or SOW draft
...
```text
You are assisting Innerflect on: Client intake.
...
Task:
Execute "Client intake" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: project-management
Playbook file: client-intake.md
```
