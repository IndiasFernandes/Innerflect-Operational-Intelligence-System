...
description: "Map market structure, buyer dynamics, and whitespace with cited evidence and explicit confidence levels."
doc_status: draft
tags:
  - playbook
---
...
Map market structure, buyer dynamics, and whitespace with cited evidence and explicit confidence levels.

## When to use

- Entering or repositioning in a category.
- Leadership needs a shared factual baseline.

## Inputs required

- Geography and segment focus
- Known competitors or substitutes
- Internal hypotheses to validate or falsify
...
```text
You are assisting Innerflect on: Market research.
...
Task:
Execute "Market research" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: marketing
Playbook file: market-research.md
```
...
- [Research report template](../../03_templates/research-report-template.md)
