...
description: "Align stakeholders on rhythm, communication, roles, and initial milestones—beyond a calendar invite."
doc_status: draft
tags:
  - playbook
---
...
Align stakeholders on rhythm, communication, roles, and initial milestones—beyond a calendar invite.

## When to use

- Execution starting after contract or approval.
- Distributed team needs shared operating rules.

## Inputs required

- Scope summary
- RACI or role list
- Tooling choices (issues, docs, chat)
...
```text
You are assisting Innerflect on: Project kickoff.
...
Task:
Execute "Project kickoff" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: project-management
Playbook file: project-kickoff.md
```
