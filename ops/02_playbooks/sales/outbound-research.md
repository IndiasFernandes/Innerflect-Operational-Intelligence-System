...
description: "Research accounts and contacts with verifiable facts, triggers, and personalization hooks—before writing copy."
doc_status: draft
tags:
  - playbook
---
...
Research accounts and contacts with verifiable facts, triggers, and personalization hooks—before writing copy.

## When to use

- Outbound or ABM motion starting or refreshing.
- Low reply rates suggest weak relevance.

## Inputs required

- ICP definition
- List source policy (compliance)
...
```text
You are assisting Innerflect on: Outbound research.
...
Task:
Execute "Outbound research" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: sales
Playbook file: outbound-research.md
```
...
- [First contact email](first-contact-email.md)
