...
description: "Design a short sequence with varied angles, clear CTAs, and stop rules—aligned to compliance and brand."
doc_status: draft
tags:
  - playbook
---
...
Design a short sequence with varied angles, clear CTAs, and stop rules—aligned to compliance and brand.

## When to use

- Pipeline needs structured follow-through.
- Reps are improvising inconsistent messaging.

## Inputs required

- Channel constraints (email, LI, phone)
- Max touches policy
...
```text
You are assisting Innerflect on: Follow-up sequence.
...
Task:
Execute "Follow-up sequence" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: sales
Playbook file: follow-up-sequence.md
```
...
- [Proposal follow-up](proposal-follow-up.md)
