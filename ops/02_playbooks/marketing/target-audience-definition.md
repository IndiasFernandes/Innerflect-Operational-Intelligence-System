...
description: "Define ICPs and segments with behaviors, triggers, objections, and channel fit—separating evidence from aspiration."
doc_status: draft
tags:
  - playbook
---
...
Define ICPs and segments with behaviors, triggers, objections, and channel fit—separating evidence from aspiration.

## When to use

- Positioning or website rewrite is underway.
- Inbound quality is misaligned with who you want to serve.

## Inputs required

- Existing customer or lead data (anonymized summaries)
- Product constraints on who can be served well
...
```text
You are assisting Innerflect on: Target audience definition.
...
Task:
Execute "Target audience definition" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: marketing
Playbook file: target-audience-definition.md
```
...
- [Offer positioning](offer-positioning.md)
