...
description: "Bound in-scope vs out-of-scope work with acceptance criteria and change-control defaults."
doc_status: draft
tags:
  - playbook
---
...
Bound in-scope vs out-of-scope work with acceptance criteria and change-control defaults.

## When to use

- Scope creep risk is high.
- Multiple stakeholders interpret the project differently.

## Inputs required

- Proposal or SOW baseline
- Known dependencies on client or third parties
...
```text
You are assisting Innerflect on: Scope definition.
...
Task:
Execute "Scope definition" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: project-management
Playbook file: scope-definition.md
```
...
- [Proposal builder](proposal-builder.md)
