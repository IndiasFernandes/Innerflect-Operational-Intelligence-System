...
description: "Ship a feature slice with tests, review discipline, and traceability from acceptance criteria to code."
doc_status: draft
tags:
  - playbook
---
...
Ship a feature slice with tests, review discipline, and traceability from acceptance criteria to code.

## When to use

- Scoped feature with clear acceptance criteria.
- You need a repeatable implementation + review flow.

## Inputs required

- Ticket with acceptance criteria
- Design notes or Figma links if UI
- Release constraints or feature flags
...
```text
You are assisting Innerflect on: Feature implementation.
...
Task:
Execute "Feature implementation" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: development
Playbook file: feature-implementation.md
```
