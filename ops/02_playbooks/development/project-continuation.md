...
description: "Resume work after a pause with recovered context, fresh risk check, and a tight plan for the next slice of work."
doc_status: draft
tags:
  - playbook
---
...
Resume work after a pause with recovered context, fresh risk check, and a tight plan for the next slice of work.

## When to use

- Work stopped for days or weeks.
- Branches or PRs may be stale; decisions may be scattered.

## Inputs required

- Last known goal and branch/PR links
- Open issues or blockers
- Changes in requirements since pause
...
```text
You are assisting Innerflect on: Project continuation.
...
Task:
Execute "Project continuation" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: development
Playbook file: project-continuation.md
```
...
- [Project continuation checklist](../../04_checklists/project-continuation.md)
- [Cursor start](cursor-start.md)
