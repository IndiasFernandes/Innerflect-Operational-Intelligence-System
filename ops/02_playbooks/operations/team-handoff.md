---
title: "Team handoff"
description: "Hand off responsibilities across people or teams with access process, WIP, and escalation paths."
doc_status: draft
tags:
  - playbook
---
...
Hand off responsibilities across people or teams with access process, WIP, and escalation paths.

## When to use

- Role change, parental leave, or vendor transition.
- Reduce single points of failure.

## Inputs required

- RACI before/after
- List of systems and on-call expectations
...
```text
You are assisting Innerflect on: Team handoff.
...
Task:
Execute "Team handoff" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: operations
Playbook file: team-handoff.md
```
