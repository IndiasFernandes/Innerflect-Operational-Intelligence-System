---
title: "Handoff"
description: "Transfer ownership with artifacts, risks, access process, and open work visible—minimizing hero dependency."
doc_status: draft
tags:
  - playbook
---
...
Transfer ownership with artifacts, risks, access process, and open work visible—minimizing hero dependency.

## When to use

- Person or vendor changing.
- Phase gate requires clean continuity.

## Inputs required

- Current state summary
- Systems list (no secrets in doc)
...
```text
You are assisting Innerflect on: Handoff.
...
Task:
Execute "Handoff" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: project-management
Playbook file: handoff.md
```
...
- [Project handoff template](../../03_templates/project-handoff-template.md)
- [Team handoff](../operations/team-handoff.md)
