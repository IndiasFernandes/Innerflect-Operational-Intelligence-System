...
description: "Benchmark category visual and verbal codes to position deliberately—not accidentally imitate the median."
doc_status: draft
tags:
  - playbook
---
...
Benchmark category visual and verbal codes to position deliberately—not accidentally imitate the median.

## When to use

- Category is crowded and sameness is a risk.
- You need a grounded reference board for creative work.

## Inputs required

- Competitor set and representative assets
- Geography and sub-segments
...
```text
You are assisting Innerflect on: Sector benchmark.
...
Task:
Execute "Sector benchmark" for the user's context. If the request spans multiple playbooks, say which playbook should own each part.

Category: branding
Playbook file: sector-benchmark.md
```
